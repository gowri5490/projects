...
By helpbutton=By.xpath("//*[@id='O365_MainLink_Help']");  //Loacting Help button (wait method)

By usernameb=By.xpath("//*[@id='mectrl_currentAccount_primary']"); //Loacting username

By aroundcogb=By.xpath("//*[@class='fontSizeXLarge']/strong");     //Loacting Around Cognizant 
 
By headers1=By.cssSelector("a[style='-webkit-line-clamp: 2;']");   //Loacting Headers
...
WebElement seeAll;
	...
	public boolean aroundCognizant() throws InterruptedException, IOException{
		...
		Thread.sleep(5000);
		mywait.until(ExpectedConditions.visibilityOfElementLocated(aroundcogb)); //Varification of Around Cognizant is Displayed
